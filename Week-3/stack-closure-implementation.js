...
console.log(stack.getStack()); // will fetch the stack --> output --> []
stack.push(10);
console.log(stack.items); // output will be "undefined" because we are not getting direct access to the stack(i.e. items)
stack.push(5);

console.log(stack.getStack()); //after the above 2 push operations output will be [10,5]
stack.pop();
...
console.log(stack.getStack()); // after pop() operation --> output [10]
stack.push(5);
console.log(stack.items); // still [10,100,1000]
console.log(stack.getStack()); // after above push(5) operation, output--> [10,5]
